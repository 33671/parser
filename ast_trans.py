...
class AstTransformer(Transformer):
    ...
    def neg(self, value):
        return AstNode(
            NodeType.UNARY_NEG, right=value, token=Token(type=TokenType.OP_SUB)
        )
    ...
    def int_literal(self, value):
        return AstNode(
            ...
            token=Token(type=TokenType.INT, value=int(value)),
            value=int(value),
        )
    ...
    def float_literal(self, value):
        return AstNode(
            ...
            token=Token(type=TokenType.FLOAT, value=float(value)),
            value=float(value),
        )
    ...
    def variable(self, name):
        return AstNode(
            NodeType.VARIABLE,
            var_name=name,
            token=Token(type=TokenType.IDENTIFIER, value=str(name)),
        )

    def break_statement(self):
        return AstNode(NodeType.FOR_BREAK)

    def continue_statement(self):
        return AstNode(NodeType.FOR_CONTINUE)
    ...
    def COMP_OP(self, op):
        ...
        match op:
            ...
            case "<=":
                op_type = TokenType.OP_LE
            case ">":
                op_type = TokenType.OP_GT
            case ">=":
                op_type = TokenType.OP_GE
            case "==":
                op_type = TokenType.OP_EQ
            case "!=":
                op_type = TokenType.OP_NE
            case "&&":
                op_type = TokenType.OP_AND
            case "||":
                op_type = TokenType.OP_OR
            case _:
    ...
    def ADD_OP(self, op):
        ...
        match op:
            case "+":
                op_type = TokenType.OP_ADD
            case "-":
                op_type = TokenType.OP_SUB
            case _:
    ...
    def MUL_OP(self, op):
        ...
        match op:
            case "*":
                op_type = TokenType.OP_MUL
            case "/":
                op_type = TokenType.OP_DIV
            case "%":
                op_type = TokenType.OP_MOD
            case _:
